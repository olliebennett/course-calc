		...
		<div id="footer">
			...
			<p>&copy; <?= date('Y') ?> | An <a href="http://olliebennett.co.uk/">Ollie Bennett</a> weekend project, with help from <a href="http://lukewoollett.com/">Luke Woollett</a>.</p>
...
if (empty($modules) || empty($yrweights)) : ?>
		<script type="text/javascript">
			incrementYear(); // Start with one year.
		</script>
<?php else: ?>
		<script type="text/javascript">
